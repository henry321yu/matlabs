...
mo=xlsread('proj\2021 proj\6 28 giant wire d for 5 26\d for 5 26.csv');
...
mo=xlsread('proj\2021 proj\7 12 time and sd speed\5 25.CSV');
t0=mo(aa,1);t0=t0-t0(1);
mo=xlsread('proj\2021 proj\7 12 time and sd speed\1號.CSV');
t1=mo(aa,1);t1=t1-t1(1);
mo=xlsread('proj\2021 proj\7 12 time and sd speed\3號.CSV');
t3=mo(aa,1);t3=t3-t3(1);
mo=xlsread('proj\2021 proj\7 12 time and sd speed\原 last.CSV');
