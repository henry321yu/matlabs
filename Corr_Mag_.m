...
mo=load('proj\2020 proj\8 11 中油 huge wire pull\LOG22.txt');
...
hold on
plot(m(51000:53000,1)+0.4-0.13)
plot(m(51000:53000,2))
plot(m(51000:53000,3)-0.3)
hold off
%% power
close all
powerdata=xlsread('proj\2020 proj\7 2 中油 iron dic and pull/POWER3.CSV');
