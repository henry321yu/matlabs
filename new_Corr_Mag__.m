...
mo1=load('proj\2020 proj\9 24 中油 iron pull big c\log0.csv');
mo2=load('proj\2020 proj\9 24 中油 iron pull big c\log1.csv');
...
mo1=load('C:\Users\henry chen\Desktop\magtest\proj\2020 proj\9 24 中油 iron pull big c\log0.csv');
mo2=load('C:\Users\henry chen\Desktop\magtest\proj\2020 proj\9 24 中油 iron pull big c\log1.csv');
...
pulldata=[t(pton(i):ptoff(i)) mo_cor((pton(i):ptoff(i)),2:4) mo_cor((pton(i):ptoff(i)),5:7) mo_cor((pton(i):ptoff(i)),8:10)];
text={'time' 'ax' 'ay' 'az' 'gx' 'gy' 'gz' 'mx' 'my' 'mz'};
